 ...
 */
package com.example.roger.sunshine.app.data;
    ...
    */
    public void testLocationTable() {
        ...
        Cursor c = db.query(WeatherContract.LocationEntry.TABLE_NAME,
                null,   // all columns
                null,   // Columns for the "WHERE" clauses
        ...
        assertTrue("Error: hauria d'existir alguna fila", c.moveToFirst() );
        ...
        assertFalse("Error: més de un record retornat", c.moveToNext() );
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: hauria d'existir alguna fila", weatherCursor.moveToFirst() );
